...
/* A compact bridge from Apple recognition to the open-source chapter. */
.ios-sparks-callout { padding: 0 48px 64px; background: var(--ink); }
.ios-sparks-callout-inner { max-width: 1224px; margin: 0 auto; padding: clamp(24px, 4vw, 48px); background: linear-gradient(115deg, #10232c, #0d151d 75%); border-radius: 4px; }
.ios-sparks-callout h2 { margin: 0 0 16px; font-size: clamp(1.6rem, 2.6vw, 2.3rem); font-weight: 400; line-height: 1.2; }
.ios-sparks-callout p { max-width: 760px; margin: 0 0 20px; color: var(--muted); line-height: 1.75; }
.ios-sparks-callout .home-tooling-link { max-width: 100%; }
@media (max-width: 700px) { .ios-sparks-callout { padding: 0 24px 40px; } }
/* A matching bridge from books to the technical-writing chapter. */
.writing-sparks-callout { padding: 0 48px 64px; background: var(--ink); }
.writing-sparks-callout-inner { max-width: 1224px; margin: 0 auto; padding: clamp(24px, 4vw, 48px); background: linear-gradient(115deg, #10232c, #0d151d 75%); border-radius: 4px; }
.writing-sparks-callout h2 { margin: 0 0 16px; font-size: clamp(1.6rem, 2.6vw, 2.3rem); font-weight: 400; line-height: 1.2; }
.writing-sparks-callout p { max-width: 760px; margin: 0 0 20px; color: var(--muted); line-height: 1.75; }
.writing-sparks-callout .home-tooling-link { max-width: 100%; }
@media (max-width: 700px) { .writing-sparks-callout { padding: 0 24px 40px; } }
