...
.desktop-links .desktop-clineflow { color: var(--cyan); white-space: nowrap; }
...
SIGNAL_STYLES += r'''
/* Three distinct editorial bridges, with a shared readable action layout. */
.ai-sparks-callout-inner, .ios-sparks-callout-inner, .writing-sparks-callout-inner {
  position: relative;
  isolation: isolate;
  overflow: hidden;
  ...
  padding-right: clamp(280px, 30%, 370px);
}
...
.sparks-bridge-art { position: absolute; right: 40px; top: 50%; width: 210px; height: 220px; transform: translateY(-50%); pointer-events: none; z-index: -1; }
...
@media (max-width: 700px) {
  .ai-sparks-callout-inner, .ios-sparks-callout-inner, .writing-sparks-callout-inner { padding: 28px 24px; border-radius: 16px; }
